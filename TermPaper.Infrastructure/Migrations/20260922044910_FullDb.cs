        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaxProjectsCount = table.Column<int>(type: "integer", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AccessRules_Attributes_AttributeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RecentlyUsedAttribute", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RecentlyUsedAttribute_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RecentlyUsedAttribute_Attributes_AttributeId",
                        column: x => x.AttributeId,
                        principalTable: "Attributes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                table: "Attributes",
                columns: new[] { "Id", "CategoryId", "DataType", "Description", "IsBuiltIn", "Name" },
                values: new object[,]
                {
                    { 1, 1, "String", "", true, "First Name" },
                    { 2, 1, "String", "", true, "Last Name" },
                    { 3, 1, "Date", "", true, "Date of Birth" },
                    { 4, 1, "String", "", true, "Phone" },
                    { 5, 1, "String", "", true, "Location" },
                    { 6, 1, "Image", "", true, "Profile Picture" },
                    { 7, 1, "Text", "", true, "About Me" }
                });

            migrationBuilder.CreateIndex(
                name: "IX_AccessRules_AttributeId",
                table: "AccessRules",
                column: "AttributeId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PositionProjectTags_PositionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RecentlyUsedAttribute_AttributeId",
                table: "RecentlyUsedAttribute",
                column: "AttributeId");

            migrationBuilder.CreateIndex(
                name: "IX_RecentlyUsedAttribute_UserId_AttributeId",
                table: "RecentlyUsedAttribute",
